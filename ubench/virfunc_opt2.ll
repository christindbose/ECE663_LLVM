...
@_ZTV7Derived = linkonce_odr hidden unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI7Derived to i8*), i8* bitcast (void (%class.Derived*)* @_ZN7Derived5printEv to i8*)] }, comdat, align 8, !type !0, !type !1, !type !2, !type !3
...
@_ZTV4Base = linkonce_odr hidden unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTI4Base to i8*), i8* bitcast (void (%class.Base*)* @_ZN4Base5printEv to i8*)] }, comdat, align 8, !type !0, !type !1
...
entry:
  ...
  %vtable = load void (%class.Base*)**, void (%class.Base*)*** %2, align 8, !tbaa !7
...
entry:
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @_ZTV7Derived, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %1, align 8, !tbaa !7
  ret void
}
...
entry:
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @_ZTV4Base, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %0, align 8, !tbaa !7
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %vtable = load i8*, i8** %0, align 8, !tbaa !7
...
entry:
  ...
  %0 = load i32, i32* %_M_streambuf_state, align 8, !tbaa !10
  ret i32 %0
}
...
entry:
  ...
  %0 = load %"class.std::ctype"*, %"class.std::ctype"** %_M_ctype, align 8, !tbaa !20
...
entry:
  ...
  %0 = load i8, i8* %_M_widen_ok, align 8, !tbaa !23
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %2, align 8, !tbaa !7
  ...
  %4 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %vfn, align 8
  %call = call signext i8 %4(%"class.std::ctype"* nonnull dereferenceable(570) %this, i8 signext %__c)
  br label %return
...
define hidden void @__typeid__ZTS4Base_0_branch_funnel(i8* nest %0, ...) {
  musttail call void (...) @llvm.icall.branch.funnel(i8* %0, i8* getelementptr (i8, i8* bitcast ({ [3 x i8*] }* @_ZTV7Derived to i8*), i64 16), void (%class.Derived*)* @_ZN7Derived5printEv, i8* getelementptr (i8, i8* bitcast ({ [3 x i8*] }* @_ZTV4Base to i8*), i64 16), void (%class.Base*)* @_ZN4Base5printEv, ...)
  ret void
}

; Function Attrs: nofree nosync nounwind willreturn
declare void @llvm.icall.branch.funnel(...) #8
